...
export const MENU_ITEMS: MenuItem[] = [
  ...
  // 3.16 Non-Veg Starters - Chicken
  { id: 'sn-nvch-1', name: 'Chicken Reshmi Kabab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-2', name: 'Chicken Tangdi Kabab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-3', name: 'Chicken Tikka', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-4', name: 'Chicken Hariyali Tikka', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-5', name: 'Grilled Chicken', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-6', name: 'Chicken 65', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-7', name: 'Chicken Tandoori', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-8', name: 'Chicken Ginger', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-9', name: 'Chicken Garlic', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-10', name: 'Chicken Butter', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-11', name: 'Chicken Fry', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-12', name: 'Chicken Hariyali', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-13', name: 'Chicken Spring Rolls', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-14', name: 'Chicken Pepper', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-15', name: 'Kasturi Kabab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-16', name: 'Chicken Manchuria (Dry/Wet)', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-17', name: 'Chicken 55', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-18', name: 'Chicken 555', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-19', name: 'Chicken Lollypop', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },
  { id: 'sn-nvch-20', name: 'Chicken Roast', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Chicken)' },

  // 3.17 Non-Veg Starters - Mutton
  { id: 'sn-nvmu-1', name: 'Mutton Shammi Kabab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-2', name: 'Mutton Sheek Kabab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-3', name: 'Mutton Spring Rolls', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-4', name: 'Mutton Chops', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-5', name: 'Mutton Macaroni', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-6', name: 'Mutton 65', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-7', name: 'Mutton Roast', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-8', name: 'Mutton Meat Balls', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-9', name: 'Boti Kabab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-10', name: 'Mutton Manchuria', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-11', name: 'Chilly Mutton', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-12', name: 'Garlic Mutton', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-13', name: 'Ginger Mutton', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-14', name: 'Pepper Mutton', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },
  { id: 'sn-nvmu-15', name: 'Mutton rolls', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Mutton)' },

  // 3.18 Non-Veg Starters - Fish
  { id: 'sn-nvfi-1', name: 'Fish Fingers', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-2', name: 'Apollo Fish', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-3', name: 'Fish Kabab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-4', name: 'Fish Fry (bone/boneless)', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-5', name: 'Fish Cutlet', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-6', name: 'Fish Tikka', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-7', name: 'Fish 65', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-8', name: 'Ginger Fish', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-9', name: 'Garlic Fish', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-10', name: 'Fish Manchuria', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-11', name: 'Pepper Fish', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-12', name: 'Chilly Fish', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-13', name: 'Fish Rolls', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-14', name: 'Fish Pakoda', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },
  { id: 'sn-nvfi-15', name: 'Fish Spring Rolls', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Fish)' },

  // 3.19 Non-Veg Starters - Egg
  { id: 'sn-nveg-1', name: 'Egg Curry (Snack)', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },
  { id: 'sn-nveg-2', name: 'Egg Omlette Curry', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },
  { id: 'sn-nveg-3', name: 'Egg Spring Rolls', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },
  { id: 'sn-nveg-4', name: 'Boiled Eggs', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },
  { id: 'sn-nveg-5', name: 'Egg Bread', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },
  { id: 'sn-nveg-6', name: 'Egg Paratha', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },
  { id: 'sn-nveg-7', name: 'Egg Dosa (Snack)', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },
  { id: 'sn-nveg-8', name: 'Egg Paneer Kurma', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },
  { id: 'sn-nveg-9', name: 'Egg Parwal Curry', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },
  { id: 'sn-nveg-10', name: 'Egg Mushroom Omlette', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },
  { id: 'sn-nveg-11', name: 'Egg Roll', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Egg)' },

  // 3.20 Non-Veg Starters - Prawns
  { id: 'sn-nvpr-1', name: 'Ginger Prawns', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Prawns)' },
  { id: 'sn-nvpr-2', name: 'Prawns 65', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Prawns)' },
  { id: 'sn-nvpr-3', name: 'Loose Prawns', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Prawns)' },
  { id: 'sn-nvpr-4', name: 'Garlic Prawns', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Prawns)' },
  { id: 'sn-nvpr-5', name: 'Pepper Prawns', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Prawns)' },
  { id: 'sn-nvpr-6', name: 'Chilly Prawns', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Prawns)' },
  { id: 'sn-nvpr-7', name: 'Prawn Pakoda', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Prawns)' },
  { id: 'sn-nvpr-8', name: 'Tandoori Prawns', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Prawns)' },
  { id: 'sn-nvpr-9', name: 'Prawn Spring Rolls', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Prawns)' },

  // 3.21 Non-Veg Starters - Crabs
  { id: 'sn-nvcr-1', name: 'Crab Fry', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Crab\'s)' },
  { id: 'sn-nvcr-2', name: 'Pepper Crab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Crab\'s)' },
  { id: 'sn-nvcr-3', name: 'Ginger Crab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Crab\'s)' },
  { id: 'sn-nvcr-4', name: 'Garlic Crab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Crab\'s)' },
  { id: 'sn-nvcr-5', name: 'Grilled Crab', isVeg: false, course: 'starters', subcategory: 'Non-Veg Starters (Crab\'s)' },
  ...
  // Chinese Rice (Veg)
  { id: 'rb-cr-1', name: 'Swechwan Rice', isVeg: true, course: 'rice-biryani', subcategory: 'Chinese Rice' },
  { id: 'rb-cr-2', name: 'Ginger Rice', isVeg: true, course: 'rice-biryani', subcategory: 'Chinese Rice' },
  { id: 'rb-cr-3', name: 'Garlic Rice', isVeg: true, course: 'rice-biryani', subcategory: 'Chinese Rice' },
  { id: 'rb-cr-4', name: 'Paneer Fried Rice', isVeg: true, course: 'rice-biryani', subcategory: 'Chinese Rice' },
  { id: 'rb-cr-5', name: 'Mushroom Fried Rice', isVeg: true, course: 'rice-biryani', subcategory: 'Chinese Rice' },
  { id: 'rb-cr-6', name: 'Manchuria Rice', isVeg: true, course: 'rice-biryani', subcategory: 'Chinese Rice' },
  { id: 'rb-cr-7', name: 'Veg Fried Rice', isVeg: true, course: 'rice-biryani', subcategory: 'Chinese Rice' },
  ...
  // Chinese Soup Items
  { id: 'sp-1', name: 'Manchow Soup', isVeg: true, course: 'Chinese Soup', subcategory: 'Soup' },
  { id: 'sp-2', name: 'Clear Soup', isVeg: true, course: 'Chinese Soup', subcategory: 'Soup' },
  { id: 'sp-3', name: 'Hot and Sour Soup', isVeg: true, course: 'Chinese Soup', subcategory: 'Soup' },
  { id: 'sp-4', name: 'Szechwan Soup', isVeg: true, course: 'Chinese Soup', subcategory: 'Soup' },
  { id: 'sp-5', name: 'Tomato Soup', isVeg: true, course: 'Chinese Soup', subcategory: 'Soup' },
  { id: 'sp-6', name: 'Sweet Corn Soup', isVeg: true, course: 'Chinese Soup', subcategory: 'Soup' },
  { id: 'sp-7', name: 'Mushroom Soup', isVeg: true, course: 'Chinese Soup', subcategory: 'Soup' },
  { id: 'sp-8', name: 'Spinach Soup', isVeg: true, course: 'Chinese Soup', subcategory: 'Soup' },

  // Chinese Noodle Items
  { id: 'nd-1', name: 'Swechwan Noodles', isVeg: true, course: 'Chinese Noodles', subcategory: 'Noodles' },
  { id: 'nd-2', name: 'Veg Soft Noodles', isVeg: true, course: 'Chinese Noodles', subcategory: 'Noodles' },
  { id: 'nd-3', name: 'Veg Fried Noodles', isVeg: true, course: 'Chinese Noodles', subcategory: 'Noodles' },
  { id: 'nd-4', name: 'Chilly Noodles', isVeg: true, course: 'Chinese Noodles', subcategory: 'Noodles' },
  { id: 'nd-5', name: 'Chowmein Noodles', isVeg: true, course: 'Chinese Noodles', subcategory: 'Noodles' },
  { id: 'nd-6', name: 'Paneer Noodles', isVeg: true, course: 'Chinese Noodles', subcategory: 'Noodles' },
  { id: 'nd-7', name: 'Mushroom Noodles', isVeg: true, course: 'Chinese Noodles', subcategory: 'Noodles' },
  { id: 'nd-8', name: 'Ginger Noodles', isVeg: true, course: 'Chinese Noodles', subcategory: 'Noodles' },
  { id: 'nd-9', name: 'Garlic Noodles', isVeg: true, course: 'Chinese Noodles', subcategory: 'Noodles' }
];
